...
char *string_nconcat(char *s1, char *s2, unsigned int n)// copiaste el 2 del anterior proyecto asi que vas a tener que cambiar cosas como que se concatena n veces
{
        char *s3;
        size_t i = 0;
